...
main() {
  ...
  test('Deve trazer itens de lista de JSON consumido via API REST', () async {
    when(() => dio.get(any())).thenAnswer((_) async => Response(
        data: jsonDecode(jsonData), requestOptions: RequestOptions(path: ' ')));
    final list = await respository.fetchToDos();
    print("Titulo encontrado:${list[193].title}");
    expect(list[193].title, 'sed ut vero sit molestiae');
